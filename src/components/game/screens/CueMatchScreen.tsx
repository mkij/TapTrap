...
import { ICONS } from "../../../engine/levels";
          ...
          <View style={[styles.inner, {
            ...
            {isFailed ? (
              ...
              <Animated.View style={{ opacity: pulseAnim }}>
                <Text style={styles.cueIcon}>{cueIcon}</Text>
              </Animated.View>
            )}
          </View>
        </Pressable>
        ...
        {isFailed ? (
          <View style={styles.revealArea}>
            ...
            <Text style={styles.revealText}>
              {matches ? `"${cueIcon}" matched your memory — don't tap!` : `"${cueIcon}" didn't match — you should tap!`}
            </Text>
          </View>
        ) : isLevelComplete ? (
          ...
          <View style={styles.cueArea}>
            <Text style={styles.cueInstruction}>Matches memory? Don't tap!</Text>
            <Text style={styles.cueHint}>Different? Tap!</Text>
          </View>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  cueIcon: { fontSize: 64, textAlign: "center" },
  ...
  cueArea: { alignItems: "center", gap: 2 },
  cueInstruction: { fontSize: 14, fontFamily: FONTS.bold, letterSpacing: 1, color: COLORS.white, textAlign: "center" },
  cueHint: { fontSize: 11, fontFamily: FONTS.regular, letterSpacing: 2, color: COLORS.textMuted },
...
export default memo(CueMatchScreen);