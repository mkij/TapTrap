    ...
    return (
        <View style={styles.wrapper}>
            ...
            <View style={styles.playArea}>
                ...
                {/* Rotate only TapZone + Instruction while playing */}
                <View style={isPlaying ? styles.rotated : undefined}>
...
export default memo(UpsideDownScreen);