...
const LEVEL_CATALOG: LevelTemplate[] = [
  ...
  // === DEVICE: Rotate ===
  {
    ...
    rule: "rotate_detect",
    params: { rotationDeg: 60 },
    category: "device",
    subCategory: "rotate",
    screenType: "rotate_screen",
    inputType: "rotate",
    difficulty: 1,
    timeLimit: 5.0,
    requiresDevice: true,
  ...
  {
    id: "D02b",
    instruction: "Rotate 90°!",
    rule: "rotate_detect",
    params: { rotationDeg: 90 },
    category: "device",
    subCategory: "rotate",
    screenType: "rotate_screen",
    inputType: "rotate",
  ...
  // === DEVICE: Vibration hint ===
  {
    id: "D03",
    instruction: "Count the vibrations, then tap",
    rule: "vibration_count",
    params: { vibrationCount: 2 },
    category: "device",
    subCategory: "vibration",
    screenType: "vibration_hint",
    inputType: "tap",
    difficulty: 1,
    timeLimit: 6.0,
    requiresDevice: true,
  ...
  {
    id: "D04",
    instruction: "Touch with 2 fingers!",
    rule: "multi_touch_detect",
    params: { fingerCount: 2 },
    category: "device",
    subCategory: "multi_touch",
    screenType: "multi_touch",
    inputType: "multi_touch",
    difficulty: 1,
    timeLimit: 5.0,
    requiresDevice: true,
  },
  {
    id: "D04b",
    instruction: "Touch with 3 fingers!",
    rule: "multi_touch_detect",
    params: { fingerCount: 3 },
    category: "device",
    subCategory: "multi_touch",
    screenType: "multi_touch",
    inputType: "multi_touch",
  ...
  {
    id: "D04c",
    instruction: "Touch with 4 fingers!",
    rule: "multi_touch_detect",
    params: { fingerCount: 4 },
    category: "device",
    subCategory: "multi_touch",
    screenType: "multi_touch",
    inputType: "multi_touch",
  ...
  // === MATH: Multiply (tap answer times) ===
  {
    ...
    instruction: "Tap 2x2",
    rule: "math_multiply",
    params: { expression: "2x2", answer: 4 },
    category: "math",
    subCategory: "arithmetic",
    screenType: "standard",
    inputType: "tap",
  ...
  },
  {
    ...
    instruction: "Tap 3x3",
    rule: "math_multiply",
    params: { expression: "3x3", answer: 9 },
    category: "math",
    subCategory: "arithmetic",
    screenType: "standard",
    inputType: "tap",
  ...
  },
  {
    ...
    instruction: "Tap 2x5",
    rule: "math_multiply",
    params: { expression: "2x5", answer: 10 },
    category: "math",
    subCategory: "arithmetic",
    screenType: "standard",
    inputType: "tap",
  ...
  },
  {
    ...
    instruction: "Tap 4x2",
    rule: "math_multiply",
    params: { expression: "4x2", answer: 8 },
    category: "math",
    subCategory: "arithmetic",
    screenType: "standard",
    inputType: "tap",
  ...
  {
    id: "MA03",
    instruction: "Tap the prime number",
    rule: "tap_prime",
    params: { numberCount: 4, targetCheck: "prime" },
    category: "math",
    subCategory: "logic",
    screenType: "number_pick",
    inputType: "tap_target",
    difficulty: 2,
    timeLimit: 5.0,
  },
  {
    ...
    instruction: "Tap the prime number",
    rule: "tap_prime",
    params: { numberCount: 5, targetCheck: "prime" },
    category: "math",
    subCategory: "logic",
    screenType: "number_pick",
    inputType: "tap_target",
  ...
  {
    id: "T01",
    instruction: "Tap at 5.0s",
    rule: "tap_at_time",
    params: { targetSec: 5, tolerance: 0.5 },
    category: "time",
  ...
  {
    id: "T01b",
    instruction: "Tap at 3.0s",
    rule: "tap_at_time",
    params: { targetSec: 3, tolerance: 0.5 },
    category: "time",
    subCategory: "precision",
    screenType: "countdown",
    inputType: "tap",
  ...
  {
    id: "T01c",
    instruction: "Tap at 4.0s",
    rule: "tap_at_time",
    params: { targetSec: 4, tolerance: 0.3 },
    category: "time",
    subCategory: "precision",
    screenType: "countdown",
    inputType: "tap",
  ...
  // === TIME: Tap before fade ===
  {
    id: "T02",
    instruction: "Tap once",
    rule: "tap_before_fade",
    params: { fadeMs: 2000, expectedRule: "tap_once" },
    category: "time",
    subCategory: "urgency",
    screenType: "fading_text",
    inputType: "tap",
    difficulty: 1,
    timeLimit: 3.0,
  },
  {
    ...
    instruction: "Double tap",
    rule: "tap_before_fade",
    params: { fadeMs: 1500, expectedRule: "double_tap" },
    category: "time",
    subCategory: "urgency",
    screenType: "fading_text",
    inputType: "tap",
  ...
  },
  {
    ...
    instruction: "Tap once",
    rule: "tap_before_fade",
    params: { fadeMs: 1000, expectedRule: "tap_once" },
    category: "time",
    subCategory: "urgency",
    screenType: "fading_text",
    inputType: "tap",
  ...
  },
  {
    ...
    instruction: "Don't tap!",
    rule: "tap_before_fade",
    params: { fadeMs: 1500, expectedRule: "dont_tap" },
    category: "time",
    subCategory: "urgency",
    screenType: "fading_text",
    inputType: "tap",
  ...
  // === TIME: Spaced double tap ===
  {
    id: "T04",
    instruction: "Double tap... slowly",
    rule: "spaced_double",
    params: { minGapMs: 1500 },
    category: "time",
    subCategory: "rhythm",
    screenType: "spaced_double",
    inputType: "tap",
    difficulty: 2,
    timeLimit: 6.0,
  },
  ...
  {
    id: "T03",
    instruction: "Hold and release in the zone!",
    rule: "hold_release",
    params: { barDurationMs: 3000, zonePercent: 25 },
    category: "time",
    subCategory: "hold",
    screenType: "hold_release",
    inputType: "hold",
    difficulty: 1,
    timeLimit: 5.0,
  },
  {
    ...
    instruction: "Hold and release in the zone!",
    rule: "hold_release",
    params: { barDurationMs: 2500, zonePercent: 20 },
    category: "time",
    subCategory: "hold",
    screenType: "hold_release",
    inputType: "hold",
  ...
  },
  {
    ...
    instruction: "Hold and release in the zone!",
    rule: "hold_release",
    params: { barDurationMs: 2000, zonePercent: 15 },
    category: "time",
    subCategory: "hold",
    screenType: "hold_release",
    inputType: "hold",
  ...
  {
    id: "D05",
    instruction: "Tap the tens digit of your battery %",
    rule: "battery_tap",
    params: {},
    category: "device",
    subCategory: "battery",
    screenType: "battery_prompt",
    inputType: "tap",
    difficulty: 2,
    timeLimit: 8.0,
    requiresDevice: true,
